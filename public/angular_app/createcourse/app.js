...
// app.js
// create angular app
var createCourseApp = angular.module('createCourseApp', ['ui.date']);


// create angular controller
createCourseApp.controller('mainController', ['$scope', '$http', '$timeout', function($scope, $http, $timeout) {
